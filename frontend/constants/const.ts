...
export const TEMPLATE_EX_OP = [
  ['EXターンオーバーⅡ?', 'EXアヴォイドHPゲインⅡ?', 'EXライブリーHPスターリングⅡ?'],
  ['EXキープバランスⅡ?', 'EXショーテージHPスターリングⅡ?', 'EXペイシェントディフェンスⅡ?'],
  ['EXステルスウォールⅡ?', 'EXダズルカムフラージュⅡ?', 'EXライブリーHPスターリングⅡ?'],
  ['EXクリティカルインライヴンⅡ?', 'EXクリティカルフォローⅡ?', ''],
  ['EXトライシールドⅡ?', 'EXトライシールドフォローⅡ?', ''],
  [
    'EXヒステリカルストレングスⅡ?',
    'EXショーテージPPバーンアップⅡ?',
    'EXエンデュアペインPBブーストⅡ?',
  ],
  ['EXリスキースタンスⅡ?', 'EXエンデュアペインPBブーストⅡ?', ''],
]
